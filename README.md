...
You can get your own fork/copy of [HacktoberFest-2022](https://github.com/Open-Source-you/HacktoberFest2022 by using the <a href="https://github.com/Open-Source-you/HacktoberFest2022/new/master?readme=1#fork-destination-box"><kbd><b>Fork</b></kbd></a> button.
...
```sh
$ git clone https://github.com/Open-Source-you/HacktoberFest2022.git
```
...
Now, let's add a reference to the original [Hacktoberfest-2022](https://github.com/Open-Source-you/HacktoberFest2022) repository using

```sh
$ git remote add upstream https://github.com/Open-Source-you/HacktoberFest2022.git
```
